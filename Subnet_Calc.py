...
#Application #1 - Part 2
        ...
        #Algotithm for subnet identification, based on IP and Subnet Mask
        ...
        #print(decimal_mask)
        #Example: fro 255.255.255.0 => 1111111111111111111111110000000000
        
        #Counting host bits in the mask and calculating number of hosts/subnet
        no_of_zeros = binary_mask.count("0")
        no_of_ones = 32 - no_of_zeros
        no_of_hosts = abs(2 ** no_of_zeros - 2) #return a positive value for the /32 ma
...
#Application #1 - Part 3
        ...
        #Example: fpr 192.168.2.100 => 11000000101010000000101000000001
        ...
        #We will end up with 4 slices of the binary IP address: [0: 8], [8: 16], [16: 24], and [24: 32]; remember that each slice goes up to, but not including, the index on the right side of the colon!
...
#Application #1 - Part 4
        ...
        while True:
            ...
            if generate == "y":
                ...
                #Obtain available IP address in range, based on the difference between octets in
                #broadcast address and network addresses
                for indexb, oct_bst in enumerate(bst_ip_address):
                    ...
                    for indexn, oct_net in enumerate(net_ip_address):
                        ...
                        if indexb == indexn:
                            if oct_bst == oct_net:
                                #add indentical octets to the generate_ip list
